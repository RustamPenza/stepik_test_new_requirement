...
class BasePage:
    ...
    # Проверяем что есть кнопка прехода на страницу авторизации/регристрации
    ...
    # Проверяем, что элемент исчезает, с использованием явного ожидания
